...
import Success from './../../assets/images/Success 1.png'
import Cookies from 'universal-cookie';

function Pelaporan(props) {
  console.log("d")
  const GetCookies = new Cookies();
  const userData = GetCookies.get('user_data')
      ...
      <div className="banner">
        <Container fluid>
          <Row className="text-center">
            <Col lg={12}>
                <h2>Selamat Datang di layanan Pelaporan D</h2>
